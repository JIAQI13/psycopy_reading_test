...
function sample_beginRoutineBegin() {
  ...
  for (const thisComponent of sample_beginComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function trial_readtimeRoutineBegin() {
  ...
  for (const thisComponent of trial_readtimeComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function trial_chooseRoutineBegin() {
  ...
  for (const thisComponent of trial_chooseComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function session_beginRoutineBegin() {
  ...
  for (const thisComponent of session_beginComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
